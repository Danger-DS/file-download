...
class info(commands.Cog):
    ...
    async def leaderboard(self, ctx):
        ...
        img_edit.text(((800-w)/2,35), 'Leaderboard - Top 10', 'white', font_thick)
        img_edit.line([((800-w)/2, (40+h)), (((800-w)/2)+w, 40+h)], fill = 'white', width = 10)
        startHeight = 140
        ...
        for aName in topTen:
            ...
            if topTen.index(aName) + 1 == 1:
                ...
                color = 'white'
            img_edit.text((75, startHeight), f'#{topTen.index(aName) + 1} {aName} - {topScores[topTen.index(aName)]} pts', color, fontToUse)
            if topTen.index(aName) > 2:
                startHeight += 77
            else:
                startHeight += 100
